...
export const Photos = () => {
  ...
  const [photoImage, setphotoImage] = useState(data[0]);
  ...
  return (
    <div className='photos'>
      <div className='gallery' data-aos="fade-up" data-aos-duration="800">GALLERY</div>
      ...
      <div className='galleryPhotos'>
        {
          data.map((item, index) => {
            return (
              <div data-aos="fade-zoom-in" data-aos-duration="500" className='individualPhotosDiv'>
        ...
        {
          photoModal &&
            <photoContext.Provider value={{photoImage,hideModal}}>
              <PhotoModal />
